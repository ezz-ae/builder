...
const TEMPLATE_FEATURES = [
  { title: "Live data ready", desc: "inventory_full + PF sync into listings, grids, and AI chats automatically." },
  { title: "Builder-verified", desc: "Every template includes previews and CMS bindings for Neon properties." },
  { title: "AI marketing", desc: "Gemini campaigns, SEO copy, and follow-up flows ship preconfigured." },
    ...
    <div className="min-h-screen bg-white text-slate-900">
      <header className="px-6 py-12 border-b border-gray-100">
        <div className="max-w-5xl mx-auto text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">29+ real estate templates—fully synced with Neon</h1>
        ...
        <div className="max-w-6xl mx-auto grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-gray-200 p-6 space-y-3 bg-white shadow-sm">
            ...
            <p className="text-sm text-slate-500">
              Choose a template and the builder will auto-populate grid, hero, and CTA blocks with Mashroi inventory and PF metadata. All colors, fonts, and CTA links stay editable.
            </p>
          ...
          <div className="rounded-2xl border border-gray-200 p-6 bg-gradient-to-br from-blue-950 to-slate-900 text-white">
            <p className="text-xs uppercase tracking-[0.3em] text-blue-300">Neon data</p>
            <h3 className="text-2xl font-semibold">Inventory sync</h3>
            <p className="text-sm text-white/80">
              Real-time feeds from `inventory_full`, `entrestaet_master`, and PF tables populate the property grids, hero sliders, and dynamic CTAs across all templates.
            </p>
            <ul className="mt-4 list-disc list-inside text-sm space-y-1 text-white/80">
              <li>Pull filters (status, price, beds) directly from API.</li>
              <li>Embed `/api/inventory` in any custom section.</li>
